            ...
            >
              ...
              <div className={`aspect-square flex items-center justify-center p-6 ${post.backgroundColor} relative overflow-hidden`}>
                <div className={`text-center ${post.textColor} z-10 relative`}>
                  <p className="text-lg md:text-xl font-semibold leading-relaxed mb-4 whitespace-pre-line">
                    {post.caption.split('\n\n')[0]}
                  </p>
                  {post.caption.split('\n\n')[1] && (
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between text-xs text-sage-500">
                  <span className="flex items-center">
                    <span className="font-medium">@psihoterapeut.oanatenea</span>
                  </span>
